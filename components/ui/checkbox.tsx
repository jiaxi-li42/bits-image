...
function Checkbox({ className, ...props }: CheckboxPrimitive.Root.Props) {
  return (
    ...
    >
      ...
      >
        {/* Show MinusIcon when indeterminate, CheckIcon when fully checked.
            base-ui mounts the Indicator for both states; we toggle via the
            Root's data-indeterminate / data-checked attributes via group/. */}
